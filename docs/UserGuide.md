...
* `find --contain-all KEYWORDS` will match persons will all keywords (i.e. `AND` search).
  e.g. `Hans Bo` will return 0 persons.  
...
**Add Tag(s)** | `add-tags INDEX [t/TAG]... `<br> e.g., `add-tags 1 t/Java Developer t/C# Developer`
