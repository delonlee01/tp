...
public class Comment {
    public static final String MESSAGE_CONSTRAINTS = "Comments must not exceed 500 characters";
    public static final String MESSAGE_NO_COMMENTS_FOUND = "Comments should not be empty";
