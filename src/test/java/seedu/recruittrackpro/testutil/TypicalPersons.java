...
public class TypicalPersons {
    ...
    /**
     * Returns an {@code RecruitTrackPro} with all the typical persons.
     */
    public static RecruitTrackPro getTypicalRecruitTrackPro() {
        RecruitTrackPro ab = new RecruitTrackPro();
